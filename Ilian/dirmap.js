const fs = require('fs'); // calls the file system module (thing that gives you the functions, 'fs' cant change)

console.log(dirreader("C:/users/Embassy of Albania/Desktop"));
